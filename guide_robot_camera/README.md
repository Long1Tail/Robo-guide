...
- Разобраться, как включать камеру только по триггеру и сразу выключать. Минусы: понадобится ожидание 0.5-2, а то и больше секунд: камере надо включиться, настроиться и только потом она выдаст кадр, но он рискует получиться тёмным/пересвеченным.
